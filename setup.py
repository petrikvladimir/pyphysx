...
setup(
    ...
    install_requires=['conan', 'numpy>=1.17,<1.21', 'imageio', 'imageio_ffmpeg', 'trimesh', 'networkx',
                      'numba', 'numpy_quaternion', 'matplotlib', 'scipy', 'anytree', 'pyrender', 'meshcat'],
    setup_requires=['pytest-runner', 'conan', 'numpy>=1.17,<1.21', 'imageio', 'imageio_ffmpeg', 'trimesh', 'networkx',
                    'numba', 'numpy_quaternion', 'matplotlib', 'scipy', 'anytree', 'pyrender', 'meshcat'],
